...
public class FileIO implements Serializable {
  ...
  // Method 1A
  // Reads data line by line from file param, and inputs into the tokenizer method2
  public Automobile readFile() {
    ...
    // caution: null pointer exception if auto object not finished ie. if not all options are added
  ...
  public void stokenizer(String myline, Automobile auto) {
    ...
    while (st1.hasMoreTokens()) {
      ...
      // first line will update the auto object, giving it a name, baseprice, and # of optionsets
  ...
  public Automobile adjustAutoProps() {
    ...
    String CarMake =
        props.getProperty(
            "CarMake"); // this is how you read a property, analogous getting a value from HashTable
  ...
  // Method 1B
  // Reads data line by line from string param, and inputs into the tokenizer method2
